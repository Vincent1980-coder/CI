...
(13, 13, 'brou001', 'Green', 'Fusce interdum ex justo, vel imperdiet erat volutpat non. Donec et maximus lacus. ', '49.00', 25, 'Vert', '', '2018-08-01', '2019-08-26 09:39:30', NULL),
...
(18, 2, 'scm0555', 'Scie à main SCM0555', 'Pellentesque fermentum ut est sagittis feugiat. Morbi in turpis augue. Maecenas dapibus ligula velit, ac gravida risus imperdiet in.', '31.19', 0, 'Bleu', '', '2018-08-19', '2019-08-26 09:39:42', NULL),
...
(42, 10, 'Mammouth', 'Tondeuse Sport', 'Monster Inside', '6500.00', 10, 'Rouge', 'jpg', '2019-08-26', '2019-08-28 16:23:47', NULL);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `role` char(15) NOT NULL DEFAULT 'utilisateur',
  PRIMARY KEY (`id`)
